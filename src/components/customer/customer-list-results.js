...
import { firebaseDeleteCustomer } from '../../utils/FirebaseUtil';
        ...
        <PerfectScrollbar>
            <Box sx={
                ...
                <Table>
                    ...
                    <TableBody > {
                        customers.slice(0, limit).map((customer) => (<TableRow hover
                            key={
                                customer.id
                            }
                            selected={
                            ...
                            <TableCell padding="checkbox" >
                                <Checkbox checked={
                                    ...
                                    onChange={
                                        (event) => handleSelectOne(event, customer.id)
                                    }
                                    value="true"/>
                            </TableCell>
                            <TableCell>
                            ...
                            <TableCell>
                                <Button color="error"
                                 variant="contained"
                                    onClick={
                                        () => firebaseDeleteCustomer('Customers',customer.id)
                                }>
                                    Delete
                                </Button>
                            </TableCell>
